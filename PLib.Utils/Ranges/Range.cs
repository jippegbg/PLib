...
namespace PLib.Utils.Ranges
{
	...
	public class Range : IEnumerable<int>, IEquatable<Range>
	{
		...
		/// <param name="other">The other range.</param>
		/// <returns>
		///     <see langword="null"/> if the current range is <see langword="null"/>, the current range if it's a
		///     superrange of the <paramref name="other"/> range, the <paramref name="other"/> range if
		///     it's a superrange of the current, or else a new range that is the combined ranges from
		///     both the current and the <paramref name="other"/> range if they are contiguous.
		/// </returns>
		...
		///     <paramref name="other"/> range is removed, <see langword="null"/> if the current range is a
		///     subrange of the <paramref name="other"/>, or the current range if no overlapping exists.
		/// </returns>
		/// <exception cref="System.ArgumentException">
		///     if the <paramref name="other"/> range is a proper
		///     subrange of the current range, and would lead to a split.
		/// </exception>
		/// <remarks>Only the subrange that overlaps is removed.</remarks>
