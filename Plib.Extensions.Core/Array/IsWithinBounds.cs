...
namespace PLib.Extensions.Core
{
	...
	public static partial class ArrayExtensions
	{
		...
		/// <returns>
		///     <b>true</b> if the <paramref name="index"/> is within the bounds of the
		///     current array; otherwise, <b>false</b>.
		/// </returns>
		...
		/// </param>
		/// <returns>
		///     <b>true</b> if the <paramref name="index"/> is within the bounds of a
		///     specified <paramref name="dimension"/> of the current multi-dimensional
		///     array; otherwise, <b>false</b>.
		/// </returns>
