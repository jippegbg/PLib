...
namespace PLib.Extensions.Core
{
	...
	public static partial class GenericArrayExtensions
	{
		...
		/// </returns>
		/// <exception cref="ArgumentNullException"><paramref name="me"/> is null.</exception>
		/// <exception cref="InvalidOperationException">
		///     <typeparamref name="T"/> does not implement the <see cref="IComparable{T}"/>
		///     generic interface.
		/// </exception>
		public static int BinarySearch<T>(this T[] me, T value)
		{
		...
		/// </exception>
		public static int BinarySearch<T>(this T[] me, T value, IComparer comparer)
		{
		...
		///     in <paramref name="me"/>.
		///     <para/>-or-<para/>
		///     <paramref name="value"/> is of a type that is not
		...
		///     generic interface.
		/// </exception>
		public static int BinarySearch<T>(this T[] me, int index, int length, T value)
		{
		...
		///     <paramref name="value"/> is of a type that is not compatible with the elements of the current array.
		/// </exception>
		/// <exception cref="InvalidOperationException">
		///     <paramref name="comparer"/> is null, <paramref name="value"/> does not implement the
		///     <see cref="IComparable"/> interface, and the search encounters an element
		///     that does not implement the <see cref="IComparable"/> interface.
		/// </exception>
		public static int BinarySearch<T>(this T[] me, int index, int length, T value, IComparer comparer)
		{
