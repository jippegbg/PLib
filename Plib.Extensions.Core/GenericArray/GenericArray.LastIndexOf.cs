...
namespace PLib.Extensions.Core
{
	...
	public static partial class GenericArrayExtensions
	{
		...
		/// <returns>
		///     The zero-based index of the last occurrence of value within the current array, if
		///     found; otherwise, –1.
		/// </returns>
		...
		/// <returns>
		///     The zero-based index of the last occurrence of value within the range of elements in
		///     array that extends from the first element to <paramref name="startIndex"/>, if found;
		///     otherwise, –1.
		/// </returns>
		public static int LastIndexOf<T>(this T[] me, T value, int startIndex)
		{
		...
		/// <returns>
		///     The zero-based index of the last occurrence of value within the range of elements in
		///     the current array that contains the number of elements specified in
		///     <paramref name="count"/> and ends at <paramref name="startIndex"/>, if found;
		///     otherwise, –1.
		/// </returns>
		public static int LastIndexOf<T>(this T[] me, T value, int startIndex, int count)
		{
