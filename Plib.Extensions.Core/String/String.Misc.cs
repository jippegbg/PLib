...
namespace PLib.Extensions.Core
{
	...
	public static partial class StringExtensions
	{
		...
		/// <returns>
		///   <see langword="true"/> if the specified other is anagram; otherwise, <see langword="false"/>.
		/// </returns>
		...
		/// <param name="ignoreCase">if set to <see langword="true"/> [ignore case].</param>
		/// <returns>
		///   <see langword="true"/> if the specified other is palindrome; otherwise, <see langword="false"/>.
		/// </returns>
		...
		/// <param name="pattern">The pattern.</param>
		/// <returns>
		///   <see langword="true"/> if the specified pattern is like; otherwise, <see langword="false"/>.
		/// </returns>
		...
		/// <param name="append">if set to <see langword="true"/> [append].</param>
		/// TODO: Edit XML Comment
