...
namespace PLib.Extensions.Core
{
	...
	public static partial class StringExtensions
	{
		...
		/// <returns>
		///   <see langword="true"/> if the specified comparison type contains all; otherwise, <see langword="false"/>.
		/// </returns>
		...
		/// <param name="values">The values.</param>
		/// <returns>
		///   <see langword="true"/> if the specified comparison type contains any; otherwise, <see langword="false"/>.
		/// </returns>
